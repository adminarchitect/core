...
@if ($actions->authorize('delete', $item))
    <a data-scaffold-action="{{ $module }}-delete"
       ...
       href="{{ route('scaffold.delete', ['module' => $module, 'id' => $item->getKey()]) }}">
